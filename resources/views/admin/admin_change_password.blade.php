		...
		<form method="post" action="{{ route('update.password') }}"  >
		 ...
		 @endif
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
				<input type="password" name="new_password" class="form-control" id="new_password" placeholder="New Password" oninput="checkPasswordMatch()" />
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
				<input type="password" name="new_password_confirmation" class="form-control" id="new_password_confirmation" placeholder="Confirm New Password" oninput="checkPasswordMatch()" />
...
function checkPasswordMatch() {
  ...
  var errorElement = document.getElementById("password_match");
