...
<span class="text-danger">Invoice : {{ $order->invoice_no }} </span></h4>
    ...
    <tr>
        <th>Order Status:</th>
        <th><span class="badge bg-warning" style="font-size: 15px;">{{ $order->status }}</span></th>
    </tr>
     ...
     <tr>
      ...
      <th>
		...
		<a href="{{ route('confirm-process',$order->id) }}" class="btn btn-block btn-success" id="process" >Process Order</a>
		
		@elseif($order->status == 'on-the-way')
		<a href="{{ route('processing-deliver',$order->id) }}" class="btn btn-block btn-success" id="deliver" >Deliver Order</a>

        @elseif($order->status == 'cancel-request')
		<a href="{{ route('process-cancel-request',$order->id) }}" class="btn btn-block btn-success" id="cancel" >Cancel Order</a>
      	@endif
