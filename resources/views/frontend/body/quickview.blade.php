<div class="modal fade custom-modal" id="quickViewModal" tabindex="-1" aria-labelledby="quickViewModalLabel" aria-hidden="true">
 ...
 <img src="" alt="product image" id="productimage"/>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <h5 class="title-detail"><a href=" " class="text-heading" id="productname"> </a></h5>
                                <br>
...
<span class="current-price text-brand">MMK</span>
...
<li class="mb-5">Stock:<span class="badge badge-pill badge-success" id="available" style="background:green; color: white;"> Jun 4.2022</span>
