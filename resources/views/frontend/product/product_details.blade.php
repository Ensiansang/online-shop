    ...
    <div class="row mb-50 mt-30">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="detail-info pr-30 pl-30">
                ...
                <h2 class="title-detail" id="details_productname">{{ $product->product_name }}</h2>
...
<div class="product-price primary-color float-left">
    <span class="current-price text-brand">MMK{{ $product->selling_price }}</span>
    
</div>
@else
<div class="product-price primary-color float-left">
                    <span class="current-price text-brand">MMK{{ $product->discount_price }}</span>
                    <span>
                        <span class="save-price font-md color3 ml-15">{{ round($discount) }}% Off</span>
                        <span class="old-price font-md ml-15">MMK{{ $product->selling_price }}</span>
                    </span>
                </div>
@endif
...
@endif
 ...
 <input type="text" name="quantity" id="details_qty" class="qty-val" value="1" min="1">
